...
import (
	...
	goonvif "github.com/BenjaminLam1202/onvif"
	"github.com/BenjaminLam1202/onvif/device"
	"github.com/BenjaminLam1202/onvif/gosoap"
	"github.com/BenjaminLam1202/onvif/xsd/onvif"
)
...
func main() {
	...
	if err != nil {
		...
		/*
			You could use https://github.com/BenjaminLam1202/onvif/gosoap for pretty printing response
		*/
